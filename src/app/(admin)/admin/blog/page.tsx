                ...
                <div key={p._id} className="p-4 hover:bg-gray-50 transition-colors flex flex-col md:flex-row items-start md:items-center gap-4 group">
                  ...
                  <div className="hidden lg:flex items-center gap-1.5 w-48 flex-wrap">
                    {displayTags.map((tag, i) => (
                      <span key={i} className="px-2 py-1 bg-blue-50 text-blue-700 text-[10px] font-bold rounded-md border border-blue-100 truncate max-w-[80px]">
                        {tag.trim()}
                      </span>
                    ))}
                  ...
                  <div className="flex items-center gap-2 shrink-0 mt-4 md:mt-0">
                    <button 
                      ...
                      title={p.featured ? "Unfeature" : "Feature Article"}
                    ...
                    <button 
                      onClick={() => { setPostToDelete(p._id); setShowDeleteModal(true); }}
                      title="Delete Post"

  ...
  return (
    <aside className="w-64 bg-card border-r border-border h-screen sticky top-0 hidden md:flex flex-col">
      <div className="p-6 border-b border-border">
        <h1 className="font-bold text-xl tracking-tight italic">
          Nilay Admin
        </h1>
      </div>
      ...
      <div className="p-4 border-t border-border">
        <button
          ...
          disabled={loggingOut}
          className="flex items-center gap-3 p-3 w-full text-left text-red-500 hover:bg-red-500/10 rounded-md text-sm font-medium transition-colors disabled:opacity-50"
        >
          <LogOut size={18} />

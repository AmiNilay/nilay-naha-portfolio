    ...
    <section className="container mx-auto px-4 max-w-4xl text-center py-20">
      ...
      <AnimatedSection direction="up" delay={0.3}>
        <div className="mt-10">
          <Link
            href="/about"
            className="px-8 py-3 rounded-full border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 hover:-translate-y-0.5 transition-all inline-block"
          >
            Read More About Me
          </Link>
        </div>

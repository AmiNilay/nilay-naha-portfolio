      ...
      <div className="max-w-4xl w-full text-center">
        ...
        >
          ...
          <StaggerItem>
            <button
              onClick={handleCopy}
              className="group relative flex flex-col items-center p-8 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl hover:border-primary/50 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 cursor-pointer w-full h-full"
            >
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm break-all">{email}</p>
          ...
          <StaggerItem>
            <Link
              ...
              target="_blank"
              className="group flex flex-col items-center p-8 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl hover:border-primary/50 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 h-full"
            >
              <div className="p-4 bg-primary/10 rounded-full mb-6 group-hover:bg-primary group-hover:text-white transition-colors duration-300">

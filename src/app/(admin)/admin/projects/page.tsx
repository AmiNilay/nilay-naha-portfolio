...
import Toast from "@/components/ui/Toast"; // Make sure you have this component
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl max-w-md w-full border border-gray-200 dark:border-gray-800">
            ...
            <div className="flex gap-3">
              <button onClick={() => setShowDeleteModal(false)} className="flex-1 py-3 font-bold bg-gray-100 dark:bg-gray-800 rounded-xl">Cancel</button>
              <button onClick={confirmDelete} disabled={isDeleting} className="flex-1 py-3 font-bold bg-red-600 text-white rounded-xl flex justify-center">
